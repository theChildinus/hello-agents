...
<div align="center">
  ...
  <a href="https://github.com/datawhalechina/hl-mas"><img src="https://img.shields.io/badge/GitHub-Project-blue?style=flat&logo=github" alt="GitHub Project"></a>
</div>
...
| **第一部分：智能体与语言模型基础** |  |  |
| [第1章 初识智能体](./chapter1/第1章%20初识智能体.md) | 智能体定义、类型、范式与应用 | 🚧 |
| [第2章 智能体发展史](./chapter2/第2章%20智能体发展史.md) | 从符号主义到 LLM 驱动的智能体演进 | 🚧 |
| [第3章 大语言模型基础](./chapter3/第3章%20大语言模型基础.md) | Transformer、提示、主流LLM及其局限 | 🚧 |
| **第二部分：构建你的大语言模型智能体** |  |  |
| [第4章 智能体的核心构件](./chapter4/第4章%20智能体的核心构件.md) | 设计原则、核心能力、记忆与工具 | 🚧 |
| [第5章 智能体经典构建范式](./chapter5/第5章%20智能体经典构建范式.md) | 手把手实现 ReAct, Plan-and-Solve, Reflection | 🚧 |
| [第6章 框架开发实践](./chapter6/第6章%20框架开发实践.md) | CAMEL, LangChain, AutoGen 等主流框架应用 | 🚧 |
| **第三部分：高级知识扩展** |  |  |
| [第7章 推理与规划](./chapter7/第7章%20推理与规划.md) | CoT, 逻辑推理, 搜索与规划 | 🚧 |
| [第8章 记忆与工具](./chapter8/第8章%20记忆与工具.md) | RAG, 向量数据库, API 调用 | 🚧 |
| [第9章 智能体通信协议](./chapter9/第9章%20智能体通信协议.md) | MCP, A2A, ANP 等协议解析 | 🚧 |
| [第10章 多智能体系统](./chapter10/第10章%20多智能体系统.md) | 协作、通信、博弈论与 AI Society | 🚧 |
| [第11章 智能体性能评估](./chapter11/第11章%20智能体性能评估.md) | 核心指标、基准测试与评估框架 | 🚧 |
| **第四部分：综合案例进阶** |  |  |
| [第12章 智能旅行助手](./chapter12/第12章%20智能旅行助手.md) | RAG与多智能体协作的真实世界应用 | 🚧 |
| [第13章 自动化深度研究智能体](./chapter13/第13章%20自动化深度研究智能体.md) | DeepResearch Agent 复现与解析 | 🚧 |
| [第16章 构建你的赛博小镇](./chapter16/第16章%20构建你的赛博小镇.md) | Agent 与游戏的结合，模拟社会动态 | 🚧 |
| **第五部分：毕业设计及未来展望** |  |  |
| [第18章 毕业设计](./chapter18/第18章%20毕业设计.md) | 构建属于你的完整多智能体应用 | 🚧 |
| [第19章 未来已来](./chapter19/第19章%20未来已来.md) | 具身智能、人机协作、挑战与机遇 | � |

### 社区贡献精选 (Community Blog)

&emsp;&emsp;欢迎大家将在学习 hl-mas 或 Agent 相关技术中的独到见解、实践总结，以 PR 的形式贡献到社区精选。

**暂无内容，期待你的第一次贡献！**

### PDF 版本下载

&emsp;&emsp;***本 hl-mas PDF 教程完全开源免费。为防止各类营销号加水印后贩卖给多智能体系统初学者，我们特地在 PDF 文件中预先添加了不影响阅读的 Datawhale 开源标志水印，敬请谅解～***

> *hl-mas PDF : https://github.com/datawhalechina/hl-mas/releases/tag/PDF*  
> *hl-mas PDF 国内下载地址 : https://www.datawhale.cn/learn/summary/XXX* 
...
<div align=center style="margin-top: 30px;">
  <a href="https://github.com/datawhalechina/hl-mas/graphs/contributors">
    <img src="https://contrib.rocks/image?repo=datawhalechina/hl-mas" />
  </a>
</div>
